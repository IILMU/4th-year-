...
| Path | Role |
|------|------|
| `app.py`, `train.py`, … | **Backend** — Flask API and training scripts at repo root |
| `frontend/` | **Frontend** — React + Vite + TypeScript (build → `frontend/dist/`) |
| `legacy_templates/` | **Fallback UI** — plain HTML if the React app is not built |
| `docs/` | **Documentation** — research brief and paper figures |
